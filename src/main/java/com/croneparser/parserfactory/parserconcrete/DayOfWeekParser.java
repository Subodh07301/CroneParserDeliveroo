 ...
 * @Version: 1.0
 *
 * @Description: This file will parse the DayOfWeek field from cron Expression
 */
public class DayOfWeekParser implements ParserInterface {
    private String description=null;
    private String expr=null;

    public DayOfWeekParser(final String expr){
        this.expr=expr;
    }

    @Override
    public void parseCroneString() throws NoSuitableParserException, InvalidCronExpression {
        description= ParsingUtil.parseCron(new StringBuilder(expr), CronParserEnum.DAY_OF_WEEK);
    }
